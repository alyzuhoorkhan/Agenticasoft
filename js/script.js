document.addEventListener('DOMContentLoaded', () => {
    ...
    // ----------------------------------------------------------
    // Set FORM_ENDPOINT to a form service URL (Formspree, Getform,
    // Web3Forms, Basin, Netlify Forms...) to receive submissions by
    // email. Leave it empty and the forms fall back to opening the
    // visitor's email client addressed to CONTACT_EMAIL.
    // ==========================================================
    const FORM_ENDPOINT = ''; // e.g. 'https://formspree.io/f/xxxxxxx'
    const CONTACT_EMAIL = 'info@agenticasoft.com';
    ...
    contactForms.forEach(form => {
        form.addEventListener('submit', function (e) {
            ...
            sendLead(new FormData(form), 'New Enquiry from AgenticaSoft Website')
                .then(() => {
                    if (FORM_ENDPOINT) window.location.href = depth + 'thankyou.html';
                })
                .catch(() => {
